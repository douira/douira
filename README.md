...
Translucency Sorting in Minecraft**. You can download the thesis text and accompanying presentation [here](https://douira.dev/).\
...
- Maintainer of the [Sodium](https://github.com/CaffeineMC/sodium) Minecraft graphics optimization mod.
